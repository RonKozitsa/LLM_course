...
│   └── create_correlation_graph.py                # Correlation visualization generator
│
...
│   ├── correlation_mistakes_vs_similarity_detailed.png  # Correlation analysis plot
...
**create_correlation_graph.py**
- Generates detailed correlation visualization
- Scatter plot with error bars (±1 SD) for each error level
- Linear regression trend line with 95% confidence interval
- Statistical analysis box (Pearson, Spearman, R², slope)
- Interpretation text explaining findings
- Saves to visualizations/correlation_mistakes_vs_similarity_detailed.png
- **Usage:** `python scripts/create_correlation_graph.py`
...
**correlation_mistakes_vs_similarity_detailed.png**
- Detailed correlation analysis visualization
- Single-panel focused plot (14" × 9")
- Scatter points with ±1 SD error bars for 17 error levels (4-20 mistakes)
- Linear regression line (red dashed) with equation
- 95% confidence interval (pink shaded region)
- Statistical metrics box: Pearson r, Spearman ρ, R², p-values
- Interpretation text at bottom explaining findings
- Publication-quality 300 DPI
- Generated by: `scripts/create_correlation_graph.py`
